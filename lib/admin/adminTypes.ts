...
export type AdminUser = { id: string; displayName: string; role: "free_user" | "editor" | "admin" | "super_admin"; advancedSearchesUsed: number; searchLimit: 3; paymentStatus: "not_applicable"; status: AdminStatus };
